...
public class SlotMachineGUI extends JFrame implements ActionListener
{
    ...
    /** Upper lefthand X coordinate of GUI */
    public static final int X = 200;
    
    /** Upper lefthand Y coordinate of GUI */
    public static final int Y = 200;
    
    /** Short time delay to make reels spin quickly*/
    public static final int SHORT_DELAY = 100;
    
    /** Long time delay to make reels spin slowly*/
    public static final int LONG_DELAY = 1000;
    
    /** Number of reel spins during normal operation */
    public static final int NORMAL_SPINS = 201;
    
    /** Number of reel spins when testing */
     ...
     * @param seed used to seed random number generator when testing
     */
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == lever) {
            ...
            spins++;
            updatePictures();
            if(spins == maxSpins - TESTING_SPINS || seed >= 0) {
                timer.setDelay(LONG_DELAY);
            }
            if(spins == maxSpins) {
                timer.stop();
